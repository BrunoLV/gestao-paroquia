...
class ApprovalAutoExecutionFailureConsistencyIntegrationTest {
    ...
    void createFailureKeepsStateConsistentAndReturnsDeterministicError() throws Exception {
        ...
        invalidPayload.put("idempotencyKey", UUID.randomUUID().toString());
        invalidPayload.put("titulo", "Evento invalido sem organizacao");
        invalidPayload.put("inicio", "2027-05-10T10:00:00Z");
        invalidPayload.put("fim", "2027-05-10T11:00:00Z");
    ...
    void updateFailureKeepsStateConsistentAndReturnsDeterministicError() throws Exception {
        ...
        UUID realEventId = UUID.fromString(objectMapper.readTree(createResult.getResponse().getContentAsString())
                .get("id").asText());
        long countBefore = eventoJpaRepository.count();
        ...
        Map<String, Object> invalidPayload = new LinkedHashMap<>();
        invalidPayload.put("eventoId", nonexistentEventId.toString());
        invalidPayload.put("inicio", "2027-06-15T10:00:00Z");
        invalidPayload.put("fim", "2027-06-15T11:00:00Z");
